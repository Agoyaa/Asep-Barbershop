					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="about.html">Location</a></li></li>
								<li><a href="news.html">Career</a></li>
								<li><a href="bookus.html">Contact Us</a></li>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<h3>Haircut </h3>
						<p class="product-price"><span>pengalaman potong rambut yang keren abis dan kece parah</span> 85$ </p>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<p class="product-price"><span>Treatment untuk rambut yang sudah rusak akibat bahan kimia</span> 70$ </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						...
						<h3>Hair Color</h3>
						<p class="product-price"><span>Buat warna rambutmu menjadi berkilau dan berwarna</span> 100$ </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="abt-bg">
						<a href="https://www.youtube.com/watch?=K0UGBkPquog?si=k4zIN-wDKc78NJkV" class="video-play-btn popup-youtube"><i class="fas fa-play"></i></a>
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
