			...
			<div class="row">
				<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
					<div class="list-box d-flex align-items-center">
						...
						<div class="content">
							<h3><a href="https://maps.app.goo.gl/EHYTggzNHZjP5SUp7" class="bawah">Jl. Raya Nagreg-Limbangan, Ciaro</h3>
							<p>Our Headquarter</p>
						</div>
					</div>
				</div>
							...
							<h2 class="subtitle">Kenapa Harus <img src="assets/img/Logo_Asep2.png" alt="">Asep Barbershop</h2>							
								...
								<div class="col-lg-6 col-md-6 mb-6 mb-md-5 mt-2">
									<div class="list-box d-flex">
										...
										<div class="content">
											...
											<p>Memiliki barberman profesional yang ahli dan mempunyai  pengalaman untuk memberikan hasil potongan rambut yang berkualitas dan sesuai dengan keinginan anda.</p>
										</div>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 mb-5 mb-md-5 mt-2">
									<div class="list-box d-flex">
										...
										<div class="content">
											<h3>Best Price</h3>
											<p>Menawarkan harga terbaik di pasaran dengan berbagai layanan yang ada bagi anda yang mencari kualitas yang baik dengan harga yang terjangkau.</p>
										</div>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 mb-5 mb-md-5 mt-2">
									<div class="list-box d-flex">
										...
										<div class="content">
											...
											<p>Lingkungan yang nyaman dan aman untuk semua anggota keluarga. Ini bisa mencakup fasilitas seperti area bermain anak-anak atau layanan khusus untuk anak-anak.</p>
										</div>
									</div>
								</div>
								<div class="col-lg-6 col-md-6">
									<div class="list-box d-flex">
										...
										<div class="content">
											<h3>Quick Refund</h3>
											<p>Menjanjikan kecepatan dalam proses pengembalian uang jika anda tidak puas dengan layanan yang diberikan dan memberikan jaminan bagi yang khawatir dengan layanan kami.</p>
										</div>
									</div>
								</div>
							</div>
